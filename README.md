...
| ------------------- | -------- | ----------- | ---------------------------------------- |
| `dotnet-sdk10-0-200`| 10.0.201 | x64 & arm64 |                                          |
| `dotnet-sdk10-0-100`| 10.0.103 | x64 & arm64 |                                          |
| `dotnet-sdk9-0-300` | 9.0.312  | x64 & arm64 |                                          |
...
| Version                | .NET SDK                     | Arch        | Remarks |
| ---------------------- | ---------------------------- | ----------- | ------- |
| `dotnet-sdk11-preview` | 11.0.100-preview.2.26159.112 | x64 & arm64 |         |
